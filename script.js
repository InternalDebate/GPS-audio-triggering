...
L.marker([52.088352, 5.129065]).addTo(map)
    .bindPopup('This is the start of the soundwalk')
    .openPopup();
...
function updateGuidance(uLat, uLng) {
    ...
    //leftover from closest zone calculation 
...
// Start Button
//start button, and a safety / information message before beginning the soundwalk
